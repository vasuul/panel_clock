...
################################################################
# This is a generated script based on design: clock_design
#
...
# source clock_design_script.tcl
...
if { $run_remote_bd_flow == 1 } {
  set str_bd_folder /home/vasuul/projects/zybo/clock/clock_fpga/bd
...
CONFIG.FREQ_HZ {125000000} \
  ...
  set hb_led [ create_bd_port -dir O hb_led ]
...
CONFIG.NUM_MI {2} \
  ...
  set settings_0 [ create_bd_cell -type ip -vlnv xulne.net:xulne:settings:1.0 settings_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins settings_0/HB_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins panel_driver_0/PANEL_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins panel_driver_0/panel_in_clk] [get_bd_pins settings_0/hb_clock]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins panel_driver_0/panel_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins settings_0/hb_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins panel_driver_0/panel_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins settings_0/hb_axi_aresetn]
  connect_bd_net -net settings_0_hb_output [get_bd_ports hb_led] [get_bd_pins settings_0/hb_output]

  # Create address segments
  create_bd_addr_seg -range 0x00100000 -offset 0x7AA00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs panel_driver_0/PANEL_AXI/PANEL_AXI_mem] SEG_panel_driver_0_PANEL_AXI_mem
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs settings_0/HB_AXI/HB_AXI_reg] SEG_settings_0_HB_AXI_reg
...
preplace port hb_led -pg 1 -y 120 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y -200 -defaultsOSRD
preplace port clk -pg 1 -y 350 -defaultsOSRD
preplace inst settings_0 -pg 1 -lvl 4 -y 120 -defaultsOSRD
...
preplace inst panel_driver_0 -pg 1 -lvl 4 -y 370 -defaultsOSRD
...
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 3 1 1430
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 700 -160 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 710
preplace netloc settings_0_hb_output 1 4 1 N
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 2 2 1100 80 1390
preplace netloc clk_1 1 0 1 N
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ -220 NJ -220 NJ -220 NJ
preplace netloc clk_wiz_0_clk_out2 1 1 3 NJ 360 NJ 360 1410
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 1080
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 0 -270 720 -140 1090 60 1400
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 3 1 1420
levelinfo -pg 1 -20 500 910 1250 1610 1770 -top -620 -bot 540
",
}
